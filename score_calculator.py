...
sentence_filter('data.txt','dataout.txt','dict3.json')
...
dict3 = json.load(open('dict3.json'))							# Trained dictionary that contains 1# Expected Value and 2# Variance.
synonyms = json.load(open('synonyms.json'))						# Synonyms dictionary.
Dependencies =[]
sentences =[]
